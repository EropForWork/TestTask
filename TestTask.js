...
(lib.TestTask = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		////////////////////////////////////////////////////////////////////////////////
		// <input id="InputTitle" style=" width: 172px; position: absolute; z-index:2; margin-left: 1710px; margin-top: 180px;" type="text" placeholder="Task title"></input>
		// <textarea id="InputText" style="resize: none; position: absolute; z-index:2; margin-left: 1710px; margin-top: 210px;" rows="30" cols="22" placeholder="Task text"></textarea>
		// <canvas id="canvas" width="1920" height="1080" style="position: absolute; display: block; background-color:rgba(204, 204, 204, 1.00);">
		////////////////////////////////////////////////////////////////////////////////
